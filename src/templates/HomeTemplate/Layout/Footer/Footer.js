...
export default function Footer() {
    ...
    return (
        <footer className="px-4 divide-y dark:bg-coolGray-800 dark:text-coolGray-100 bg-gray-700 text-white">
            ...
            <div className="py-6 text-sm text-center text-gray-400">© 2021 Company Co. All rights reserved.</div>
        </footer>
